"""GR-ConvNet (v3) -- GenerativeResnet.

Vendored verbatim (with formatting) from
https://github.com/skumra/robotic-grasping/blob/master/inference/models/grconvnet3.py
so the pretrained Cornell RGB-D checkpoint loads with strict shape matching.

Paper: Kumra, Joshi, Sahin, "Antipodal Robotic Grasping using Generative Residual
Convolutional Neural Network", IROS 2020.
